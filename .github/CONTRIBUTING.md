...
Please start a discussion on the [core repo issue tracker](https://github.com/iamshen/IdentityServer8/issues).
...
1. Did you read the [documentation](https://IdentityServer4.readthedocs.io/en/latest/)?
2. Did you include the snippet of broken code in the issue?
3. What are the *EXACT* steps to reproduce this problem?
4. Did you enable [logging](https://IdentityServer4.readthedocs.io/en/latest/topics/logging.html)?
