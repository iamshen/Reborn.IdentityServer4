...
The repo for this support is located `here <https://github.com/alexhiggins732/IdentityServer4.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/Reborn.IdentityServer4.AspNetIdentity>`_.
