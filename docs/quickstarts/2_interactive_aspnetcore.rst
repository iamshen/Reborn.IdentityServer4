...
This UI can be found in the `Quickstart UI repo <https://github.com/alexhiggins732/IdentityServer4.Quickstart.UI/tree/main>`_.
...
You can inspect the source code `here <https://github.com/alexhiggins732/IdentityServer4/blob/main/src/IdentityServer4/src/Test/TestUserProfileService.cs>`_
to see how it works.
...
We have a `cloud-hosted demo <https://demo.IdentityServer4.io>`_ version of IdentityServer4 which you can integrate using OpenID Connect.
...
Add the OpenId Connect handler to DI::
    ...
    services.AddAuthentication()
        ...
        .AddOpenIdConnect("oidc", "Demo IdentityServer", options =>
        {
            ...
            options.Authority = "https://demo.IdentityServer4.io/";
...
.. note:: The quickstart UI auto-provisions external users. As an external user logs in for the first time, a new local user is created, and all the external claims are copied over and associated with the new user. The way you deal with such a situation is completely up to you though. Maybe you want to show some sort of registration UI first. The source code for the default quickstart can be found `here <https://github.com/alexhiggins732/IdentityServer4.Quickstart.UI>`_. The controller where auto-provisioning is executed can be found `here <https://github.com/alexhiggins732/IdentityServer4.Quickstart.UI/blob/main/Quickstart/Account/ExternalController.cs>`_.
