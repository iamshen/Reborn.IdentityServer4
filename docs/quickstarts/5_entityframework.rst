...
.. Note:: You can find the `latest SQL scripts <https://github.com/iamshen/IdentityServer8/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for SqlServer in the IdentityServer4.EntityFramework.Storage repository.
