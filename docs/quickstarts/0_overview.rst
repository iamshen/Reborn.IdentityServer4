...
`samples <https://github.com/alexhiggins732/IdentityServer4/tree/main/samples/Quickstarts>`_ folder.
...
.. note:: The quickstarts target the IdentityServer 4.x and ASP.NET Core 3.1.x - there are also quickstarts for `ASP.NET Core 2 <http://docs.IdentityServer4.io/en/aspnetcore2/quickstarts/0_overview.html>`_ and `ASP.NET Core 1 <http://docs.IdentityServer4.io/en/aspnetcore1/quickstarts/0_overview.html>`_.
