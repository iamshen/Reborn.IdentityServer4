...
[![Master | Build](https://github.com/iamshen/IdentityServer8/actions/workflows/master.yml/badge.svg)](https://github.com/iamshen/IdentityServer8/actions/workflows/master.yml)
[![Release|Build](https://github.com/iamshen/IdentityServer8/actions/workflows/release.yml/badge.svg)](https://github.com/iamshen/IdentityServer8/actions/workflows/release.yml)

[![Develop|Build](https://github.com/iamshen/IdentityServer8/actions/workflows/develop.yml/badge.svg)](https://github.com/iamshen/IdentityServer8/actions/workflows/develop.yml)
[![CI/CD|Build](https://github.com/iamshen/IdentityServer8/actions/workflows/pre-release.yml/badge.svg)](https://github.com/iamshen/IdentityServer8/actions/workflows/pre-release.yml)

## Code Coverage
[![Master | Build](https://github.com/iamshen/IdentityServer8/actions/workflows/master.yml/badge.svg)](https://img.shields.io/codecov/c/github/alexhiggins732/IdentityServer4) [![Master|CodeQL](https://github.com/iamshen/IdentityServer8/actions/workflows/codeql.yml/badge.svg)](https://github.com/iamshen/IdentityServer8/actions/workflows/codeql.yml)

[![Develop|Build](https://github.com/iamshen/IdentityServer8/actions/workflows/develop.yml/badge.svg)](https://img.shields.io/codecov/c/github/alexhiggins732/IdentityServer4/tree/develop)
[![Master|CodeQL](https://github.com/iamshen/IdentityServer8/actions/workflows/codeql.yml/badge.svg?branch=develop)](https://github.com/iamshen/IdentityServer8/actions/workflows/codeql.yml?branch=develop)
...
## Branch structure
Active development happens on the main branch. This always contains the latest version. Each (pre-) release is tagged with the corresponding version. The [aspnetcore1](https://github.com/iamshen/IdentityServer8/tree/aspnetcore1) and [aspnetcore2](https://github.com/iamshen/IdentityServer8/tree/aspnetcore2) branches contain the latest versions of the older ASP.NET Core based versions.
...
Please use the [issue tracker](https://github.com/iamshen/IdentityServer8/issues) for that. We only support the latest version for free. For older versions, you can get a commercial support agreement with us.
...
You can see a list of our current sponsors [here](https://github.com/iamshen/IdentityServer8/blob/main/SPONSORS.md) - and for companies we have some nice advertisement options as well.
...
..and last but not least a big thanks to all our [contributors](https://github.com/iamshen/IdentityServer8/graphs/contributors)!
